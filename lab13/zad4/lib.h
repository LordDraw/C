...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>struktury/zad4/lib.h at master from mmotel/c - GitHub</title>
...
<script src="https://d3nwyuy0nl342s.cloudfront.net/ba26f6a198e5e881573c321692d2255635b24eb8/javascripts/bundle_github.js" type="text/javascript"></script>
  ...
  <link rel='canonical' href='/mmotel/c/blob/2c1d91162aa86e96c599f6fe78bf3c3ff5994326/struktury/zad4/lib.h'>
  ...
  <link href="https://github.com/mmotel/c/commits/master.atom" rel="alternate" title="Recent Commits to c:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'struktury/zad4/lib.h';
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="struktury/zad4/lib.h/">
      <b><a href="/mmotel/c/tree/1b1382b3c68aa72230b6f29fd59b2d3466db0489">c</a></b> / <a href="/mmotel/c/tree/1b1382b3c68aa72230b6f29fd59b2d3466db0489/struktury">struktury</a> / <a href="/mmotel/c/tree/1b1382b3c68aa72230b6f29fd59b2d3466db0489/struktury/zad4">zad4</a> / lib.h       <span style="display:none" id="clippy_1076">struktury/zad4/lib.h</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_1076&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://d3nwyuy0nl342s.cloudfront.net/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_1076&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="struktury/zad4/lib.h/" data-canonical-url="/mmotel/c/blob/1b1382b3c68aa72230b6f29fd59b2d3466db0489/struktury/zad4/lib.h">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/mmotel/c/file-edit/__current_ref__/struktury/zad4/lib.h"><span>Edit this file</span></a></li>
          </ul>
            ...
            <div class="meta">
              <div class="info">
                ...
                <span class="mode" title="File Mode">100644</span>
                  ...
                  <span>18 lines (9 sloc)</span>
                
                <span>0.425 kb</span>
              </div>
              <ul class="actions">
                <li><a href="/mmotel/c/raw/master/struktury/zad4/lib.h" id="raw-url">raw</a></li>
                
                  <li><a href="/mmotel/c/blame/master/struktury/zad4/lib.h">blame</a></li>
                
                <li><a href="/mmotel/c/commits/master/struktury/zad4/lib.h">history</a></li>
              </ul>
            </div>
...
<span id="L18" rel="#L18">18</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="k">struct</span> <span class="n">point</span> <span class="n">makepoint</span><span class="p">(</span><span class="kt">int</span> <span class="n">x</span><span class="p">,</span> <span class="kt">int</span> <span class="n">y</span><span class="p">);</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="k">struct</span> <span class="n">rect</span> <span class="n">makerect</span><span class="p">(</span><span class="k">struct</span> <span class="n">point</span> <span class="n">ll</span><span class="p">,</span> <span class="k">struct</span> <span class="n">point</span> <span class="n">ur</span><span class="p">);</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="kt">int</span> <span class="n">ptinrect</span><span class="p">(</span><span class="k">struct</span> <span class="n">point</span> <span class="n">p</span><span class="p">,</span> <span class="k">struct</span> <span class="n">rect</span> <span class="n">r</span><span class="p">);</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'><span class="kt">int</span> <span class="n">rectinrect</span><span class="p">(</span><span class="k">struct</span> <span class="n">rect</span> <span class="n">r1</span><span class="p">,</span> <span class="k">struct</span> <span class="n">rect</span> <span class="n">r2</span><span class="p">);</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><span class="kt">int</span> <span class="n">disjointrect</span><span class="p">(</span><span class="k">struct</span> <span class="n">rect</span> <span class="n">r1</span><span class="p">,</span> <span class="k">struct</span> <span class="n">rect</span> <span class="n">r2</span><span class="p">);</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'><span class="kt">int</span> <span class="n">cz_ws_ll</span><span class="p">(</span><span class="k">struct</span> <span class="n">rect</span> <span class="n">r1</span><span class="p">,</span> <span class="k">struct</span> <span class="n">rect</span> <span class="n">r2</span><span class="p">);</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'><span class="kt">int</span> <span class="n">cz_ws_ur</span><span class="p">(</span><span class="k">struct</span> <span class="n">rect</span> <span class="n">r1</span><span class="p">,</span> <span class="k">struct</span> <span class="n">rect</span> <span class="n">r2</span><span class="p">);</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'><span class="kt">int</span> <span class="n">area</span> <span class="p">(</span><span class="k">struct</span> <span class="n">rect</span> <span class="n">r1</span><span class="p">,</span> <span class="k">struct</span> <span class="n">rect</span> <span class="n">r2</span><span class="p">);</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'><span class="kt">void</span> <span class="n">scanrect</span><span class="p">(</span><span class="kt">char</span> <span class="o">*</span><span class="n">prompt</span><span class="p">,</span> <span class="k">struct</span> <span class="n">rect</span> <span class="o">*</span><span class="n">r</span><span class="p">);</span></div><div class='line' id='LC18'><br/></div></pre></div>
  ...
  <img src="https://d3nwyuy0nl342s.cloudfront.net/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.06199s from fe3.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
